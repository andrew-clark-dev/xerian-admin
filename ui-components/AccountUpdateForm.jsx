...
export default function AccountUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setIsMobile(cleanValues.isMobile);
    ...
    setComunicationPreferences(cleanValues.comunicationPreferences);
    setStatus(cleanValues.status);
    setKind(cleanValues.kind);
    setDefaultSplit(cleanValues.defaultSplit);
    setTransactions(cleanValues.transactions ?? []);
    setCurrentTransactionsValue("");
    setBalance(cleanValues.balance);
    setNoSales(cleanValues.noSales);
    setNoItems(cleanValues.noItems);
    setLastActivityAt(cleanValues.lastActivityAt);
    setLastItemAt(cleanValues.lastItemAt);
    setLastSettlementAt(cleanValues.lastSettlementAt);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          comunicationPreferences: comunicationPreferences ?? null,
          status: status ?? null,
          kind: kind ?? null,
          defaultSplit: defaultSplit ?? null,
          transactions: transactions ?? null,
          balance: balance ?? null,
          noSales: noSales ?? null,
          noItems: noItems ?? null,
          lastActivityAt: lastActivityAt ?? null,
          lastItemAt: lastItemAt ?? null,
          lastSettlementAt: lastSettlementAt ?? null,
          tags: tags ?? null,
    ...
    >
      ...
      >
        ...
        <option
          children="Customer"
          value="Customer"
          {...getOverrideProps(overrides, "kindoption4")}
        ></option>
        <option
          children="Owner"
          value="Owner"
          {...getOverrideProps(overrides, "kindoption5")}
        ></option>
      </SelectField>
      <TextField
        label="Default split"
      ...
      <ArrayField
        ...
        setFieldValue={setCurrentTransactionsValue}
      ...
      >
        <TextField
          ...
          isRequired={false}
          isReadOnly={false}
          value={currentTransactionsValue}
          onChange={(e) => {
            let { value } = e.target;
            if (errors.transactions?.hasError) {
              runValidationTasks("transactions", value);
            }
            setCurrentTransactionsValue(value);
          }}
          onBlur={() =>
            runValidationTasks("transactions", currentTransactionsValue)
          }
          errorMessage={errors.transactions?.errorMessage}
          hasError={errors.transactions?.hasError}
          ref={transactionsRef}
      ...
      >
        <Button
          ...
          isDisabled={!(numberProp || accountModelProp)}
