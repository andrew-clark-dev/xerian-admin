...
export default function ItemUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSplit(cleanValues.split);
    setPrice(cleanValues.price);
    setStatus(cleanValues.status);
    setSales(cleanValues.sales ?? []);
    setCurrentSalesValue("");
    setPrintedAt(cleanValues.printedAt);
    setLastSoldAt(cleanValues.lastSoldAt);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = skuProp
        ? (
            await client.graphql({
              query: getItem.replaceAll("__typename", ""),
              variables: { sku: skuProp },
            })
          )?.data?.getItem
        : itemModelProp;
    ...
    >
      ...
      >
        ...
        <option
          children="Unknown"
          value="Unknown"
          {...getOverrideProps(overrides, "statusoption12")}
        ></option>
      </SelectField>
      <ArrayField
        onChange={async (items) => {
        ...
        setFieldValue={setCurrentSalesValue}
      ...
      >
        <TextField
          ...
          onChange={(e) => {
            ...
            setCurrentSalesValue(value);
          }}
          onBlur={() => runValidationTasks("sales", currentSalesValue)}
          errorMessage={errors.sales?.errorMessage}
          hasError={errors.sales?.hasError}
          ref={salesRef}
          labelHidden={true}
      ...
      >
        <Button
          ...
          isDisabled={!(skuProp || itemModelProp)}
