...
export default function SaleCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setRefund(initialValues.refund);
    setAccountTotal(initialValues.accountTotal);
    setStoreTotal(initialValues.storeTotal);
    setTransaction(initialValues.transaction);
    setRefundedSale(initialValues.refundedSale);
